...
const Navbar = () => {
  ...
  return (
    <div className="od-navbar sticky top-0 z-[100] dark:border-gray-500/30 sm:border-b sm:border-gray-900/10 sm:bg-white sm:bg-opacity-80 sm:backdrop-blur-md sm:dark:bg-gray-900">
      <Toaster />
      ...
      <div className="mx-auto flex w-full items-center justify-between space-x-4 px-4 py-1">
        ...
        <div className="flex flex-1 items-center space-x-4 text-gray-700 md:flex-initial">
          <button
            className="flex flex-1 items-center justify-between rounded-lg px-2.5 py-1.5 hover:opacity-80 dark:text-white md:w-48" style={{ backgroundColor: "rgba(255,255,255,0.35)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", border: "1px solid rgba(255,255,255,0.45)" }}
